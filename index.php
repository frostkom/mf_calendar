...
if(!function_exists('is_plugin_active') || function_exists('is_plugin_active') && is_plugin_active("mf_base/index.php"))
{
	...
	function uninstall_calendar()
	{
		...
		mf_uninstall_plugin(array(
			...
			'options' => array('setting_google_calendar_api_key', 'setting_calendar_events_exclude_from_search', 'setting_calendar_date_bg', 'setting_calendar_image_fallback', 'setting_calendar_time_limit', 'setting_calendar_debug'),
		));
	}
}