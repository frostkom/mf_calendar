		...
		.widget.calendar .section > ul
		{
			...
			.widget.calendar .section .calendar_feed_item
			{
				...
				.widget.calendar .section .calendar_feed_item + li
				{
					...
					.widget.calendar .section .calendar_feed_item .start_date a
					{
						...
						foreach($setting_calendar_calendar_colors_result as $r)
						{
							...
							echo ".widget.calendar .section .calendar_feed_".$post_id." .start_date a
							{
					...
					.widget.calendar .section .calendar_feed_item .content
					{
						...
						.widget.calendar .section .calendar_feed_item .meta
						{
							...
							.widget.calendar .section .calendar_feed_item p > .fa.toggle_icon
							{
								margin-left: .4em;
							}
